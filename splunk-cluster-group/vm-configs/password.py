...
"""Adc DM template that generates password as an output, namely "password".
...
CATEGORIES_WITH_SYMBOLS = [ LOWERS, DIGITS, SYMBOLS]
CATEGORIES_WITHOUT_SYMBOLS = [ LOWERS, DIGITS]
